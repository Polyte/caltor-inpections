      ...
      <div className="space-y-6">
        ...
        <Alert className="border-orange-200 bg-orange-50">
          ...
          <AlertDescription className="text-orange-800">
            <div className="space-y-3">
              ...
              <p>
                To use the notification system, you need to configure your Supabase environment variables in your{" "}
        ...
        <Card className="opacity-50">
          <CardHeader>
            ...
            <CardDescription>Control your overall notification preferences (requires configuration)</CardDescription>
          </CardHeader>
  ...
  if (!preferences) {
    return (
      <div className="space-y-6">
        ...
        <Alert>
          <AlertDescription>Unable to load notification preferences. Please try refreshing the page.</AlertDescription>
        </Alert>
      </div>
    )
  }
