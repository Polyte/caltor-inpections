  ...
  if (typeof window === "undefined") {
    ...
    return {
      auth: {
        ...
        signUp: () => Promise.resolve({ data: { user: null, session: null }, error: new Error("Server-side mock") }),
        signInWithPassword: () =>
  ...
  try {
    ...
    return {
      auth: {
        ...
        signOut: () => Promise.resolve({ error: null }),
        signUp: () =>
          Promise.resolve({ data: { user: null, session: null }, error: new Error("Supabase client creation failed") }),
        signInWithPassword: () =>
          Promise.resolve({ data: { user: null, session: null }, error: new Error("Supabase client creation failed") }),
